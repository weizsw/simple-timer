  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 w-96 shadow-2xl">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Set Timer</h2>
        ...
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Minutes</label>
              <input
                type="number"
                min="0"
                max="59"
          ...
          <div className="flex gap-2 mt-6">
            <button
              onClick={() => onClose(parseInt(hours), parseInt(minutes))}
